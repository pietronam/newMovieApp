import { handleMovieSearch } from "./searchGetters.js";
...
export const searchAndCreateCards = async () => {
    let cardContainer = document.getElementById("search-results");
    ...
    createSearchCards(searchData.results, "search-results");
};